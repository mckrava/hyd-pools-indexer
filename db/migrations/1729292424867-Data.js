module.exports = class Data1729292424867 {
    name = 'Data1729292424867'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "stablepool_asset_liquidity_amount" ("id" character varying NOT NULL, "asset_id" integer NOT NULL, "amount" numeric NOT NULL, "liquidity_action_id" character varying, CONSTRAINT "PK_39bfb296ffd91f0b8199c6ed40f" PRIMARY KEY ("id"))`)
