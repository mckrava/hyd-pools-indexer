module.exports = class Data1729268780190 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "stablepool_asset" ("id" character varying NOT NULL, "asset_id" integer NOT NULL, "amount" numeric NOT NULL, "pool_id" character varying, CONSTRAINT "PK_2a5a7e5d0e0b4e78735d7283efd" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stablepool_asset_historical_volume" ("id" character varying NOT NULL, "asset_id" integer NOT NULL, "asset_fee" numeric NOT NULL, "asset_total_fees" numeric NOT NULL, "swap_volume_in" numeric NOT NULL, "swap_volume_out" numeric NOT NULL, "swap_total_volume_in" numeric NOT NULL, "swap_total_volume_out" numeric NOT NULL, "liq_added_amount" numeric NOT NULL, "liq_removed_amount" numeric NOT NULL, "liq_added_total_amount" numeric NOT NULL, "liq_removed_total_amount" numeric NOT NULL, "routed_liq_added_amount" numeric NOT NULL, "routed_liq_removed_amount" numeric NOT NULL, "routed_liq_added_total_amount" numeric NOT NULL, "routed_liq_removed_total_amount" numeric NOT NULL, "volumes_collection_id" character varying, CONSTRAINT "PK_f29e4428893d4cea7bae0d936ce" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_81822becf0ad9be5c5cad9d00c" ON "stablepool_asset_historical_volume" ("volumes_collection_id") `)
        await db.query(`CREATE TABLE "stablepool_operation" ("id" character varying NOT NULL, "asset_in_id" integer NOT NULL, "asset_in_amount" numeric NOT NULL, "asset_out_id" integer NOT NULL, "asset_out_amount" numeric NOT NULL, "asset_fee" numeric NOT NULL, "type" character varying(4) NOT NULL, "extrinsic_hash" text, "index_in_block" integer NOT NULL, "relay_chain_block_height" integer NOT NULL, "para_chain_block_height" integer NOT NULL, "account_id" character varying, "pool_id" character varying, CONSTRAINT "PK_4cea7b9ff3c3b0d7f9218531d4d" PRIMARY KEY ("id"))`)
